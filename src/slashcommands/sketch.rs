...
pub async fn run(
    ...
    generate_stable_diffuse_image(&prompt_args_clone,&negative_prompt_args_clone, 768, 768,50, 2, true, 0, ImageFilter::NoFilter,0.5, high_res_args_clone).await.unwrap() // 944x944 891k for paragon
}
